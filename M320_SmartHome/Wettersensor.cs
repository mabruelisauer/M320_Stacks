...
namespace M320_SmartHome {
    public class Wettersensor {
        ...
        public Wetterdaten GetWetterdatenFake(int Temperature, int wind, bool regen) {
            return new Wetterdaten { Aussentemperatur = Temperature, Windgeschwindigkeit = wind, Regen = regen };
        }
